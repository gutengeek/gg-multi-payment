...
$defaults = [
	...
	'description'     => null,
	'placeholder'     => '',
	'class'           => 'ggmp-datepicker regular-text form-control',
	'data'            => false,
	'disabled'        => false,
	'date_format'     => '',
	'date_storage'    => '',
...
$output = '<div class="ggmp-field-wrap ggmp-date-field-wrap form-group" id="' . sanitize_key( $this->form_id . $args['id'] ) . '-wrap">';
if ( $args['show_label'] ) {
