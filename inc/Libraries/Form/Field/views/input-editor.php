...
echo '<div class="ggmp-field-wrap ggmp-editor-field-wrap form-group ' . $args['unique_field_id'] . '_field ' . esc_attr( $args['wrapper_class'] ) . '"' . $data_wp_editor . '><label for="' .
     $args['unique_field_id'] .
...
if ( ! empty( $args['description'] ) ) {
	echo '<p class="ggmp-description">' . $args['description'] . '</p>';
}
