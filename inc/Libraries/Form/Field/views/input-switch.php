...
$defaults = [
	...
	'name'        => '',
	'description' => null,
	'class'       => 'ggmp-switch form-control',
	'wrap_class'  => '',
	'data'        => [],
	'disabled'    => false,
	'default'     => '',
...
$output .= '<div class="ggmp-field-wrap ggmp-switch-field-wrap form-group ' . $wrap_class . '" id="' . sanitize_key( $this->form_id . $args['id'] ) . '-wrap">';

if ( $args['name'] ) {
	$output .= '<label class="ggmp-label" for="' . sanitize_key( $this->form_id . $args['id'] ) . '">' . esc_html( $args['name'] ) . '</label>';
}
$output .= '<div class="ggmp-field-main">';
$output .= '<label class="ggmp-switch-input">';
