...
$output = '<div class="ggmp-field-wrap ggmp-textarea-field-wrap form-group" id="ggmp-' . sanitize_key( $this->form_id . $args['id'] ) . '-wrap">';

if(  $this->show_label ) {
	$output .= '<label class="ggmp-label" for="ggmp-' . sanitize_key( $this->form_id . $args['id'] ) . '">' . esc_html( $args['name'] ) . '</label>';
}
$data = '';
if ( $args['required'] ) {
