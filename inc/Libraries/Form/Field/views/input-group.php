...
?>
<div class="ggmp-group-field-wrap ggmp-repeatable-field-section <?php echo esc_attr( $wrapper_class ); ?>" data-field="<?php echo "{$args['id']}"; ?>" id="<?php echo "{$args['id']}_field"; ?>"
	...
	<?php if ( ! empty( $args['name'] ) ) : ?>
        <p class="ggmp-repeater-field-name"><?php echo trim( $args['name'] ); ?></p>
	<?php endif; ?>

	<?php if ( ! empty( $args['description'] ) ) : ?>
        <p class="ggmp-repeater-field-description"><?php echo esc_html( $args['description'] ); ?></p>
	<?php endif; ?>

    <table class="ggmp-repeatable-fields-section-wrapper" cellspacing="0">
		<?php
		$repeater_field_values = $this->get_field_value( $args );

		$header_title = isset( $args['options']['header_title'] )
			? $args['options']['header_title']
			: esc_attr__( 'Group', 'ggmp' );
        ...
        <tr class="ggmp-template">
            <td class="ggmp-repeater-field-wrap ggmp-column" colspan="2">
                <div class="opal-row-head ggmp-move">
                    ...
                    <div class="button-action-group">
                    	<span class="ggmp-remove button-action" title="<?php esc_attr_e( 'Remove Group', 'ggmp' ); ?>">
        ...
        <tr>
			...
			$add_row_btn_title = isset( $args['options']['add_button'] )
				...
				: esc_html__( 'Add Row', 'ggmp' );
			?>
            <td colspan="2" class="ggmp-add-repeater-field-section-row-wrap">
