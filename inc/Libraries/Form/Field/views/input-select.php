...
$defaults = [
	...
	'options'          => [],
	'description'      => null,
	'class'            => 'ggmp-select form-control',
	'wrap_class'       => '',
	'autocomplete'     => 'off',
	'selected'         => 0,
	'chosen'           => false,
...
$output .= '<div class="ggmp-field-wrap ggmp-select-field-wrap form-group '. esc_attr( $wrap_class ) .'" id="' . sanitize_key( $this->form_id . $args['id'] ) . '-wrap" >';
if ( $this->show_label ) {
