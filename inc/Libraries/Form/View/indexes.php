...
?>
    ...
    <div class="js-ggmp-metabox-wrap metabox-panel-wrap">
        <div class="ggmp-tab ggmp-tab-verticle">
            <ul class="ggmp-form-data-inline-tabs ggmp-metabox-inline-tabs ggmp-tab-head">
                        ...
                        <a href="#<?php echo $form_data_tab['id']; ?>"
                           data-tab-id="<?php echo $form_data_tab['id']; ?>">
                            ...
                            <?php else : ?>
                                <span class="ggmp-icon ggmp-icon-default"></span>
                            <?php endif; ?>
                            <span class="ggmp-label"><?php echo $setting['title']; ?></span>
                        </a>
                     </div>
                ...
                <?php if ( $this->has_sub_tab( $setting ) ) : ?>
                    <?php if ( ! empty( $setting['sub-fields'] ) ) : ?>
                        <?php foreach ( $setting['sub-fields'] as $index => $sub_fields ) : ?>
                            <div id="<?php echo $sub_fields['id']; ?>" class="panel ggmp_options_panel ggmp-hidden ggmp-panel">
