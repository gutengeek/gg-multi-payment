...
class View {
	...
	public static function render_template( $template_name, $args = [], $template_path = '', $default_path = '' ) {
		...
		ob_start();
		do_action( 'ggmp_before_template_render', $template_name, $template_path, $located, $args );
		include( $located );
		do_action( 'ggmp_after_template_render', $template_name, $template_path, $located, $args );
	...
	public static function locate_template( $template_name, $template_path = '', $default_path = '' ) {
		...
		if ( ! $default_path ) {
			$default_path = GGMP_DIR . '/templates/';
		}
		...
		if ( file_exists( $template ) ) {
			...
			return apply_filters( 'ggmp_locate_template', $template, $template_name, $template_path );
		} else {
			return false;
		}
	}
